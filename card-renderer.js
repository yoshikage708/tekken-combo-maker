...
function canvasNumpad(c,x,y,size,label,held=false){c.fillStyle=held?'#f1b84b':'#f5f7fa';c.font=`800 ${Math.round(size*.82)}px Arial,"Yu Gothic",sans-serif`;c.textAlign='center';c.textBaseline='middle';c.fillText(label,x+size/2,y+size/2+2);c.textAlign='left';c.textBaseline='alphabetic'}
