...
function drawComboIcons(c,startX,startY,maxX){
  ...
  combo.forEach(item=>{
    ...
    if(item.type==='direction'){
      ...
      const dir=item.label==='前ステ'?'6':'4';canvasArrow(c,tx,ty+3,34,dir,false);canvasArrow(c,tx+20,ty+3,34,dir,false,true);c.fillStyle='#b8c0cc';c.font='700 12px "Yu Gothic",sans-serif';c.textAlign='center';c.fillText(item.label,tx+32,ty+57);c.textAlign='left'
